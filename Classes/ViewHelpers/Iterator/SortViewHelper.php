...
/*
 * This file adapted from the FluidTYPO3/Vhs project
 */

use TRAW\VhsCol\Traits\ArrayConsumingViewHelperTrait;
use TRAW\VhsCol\Traits\TemplateVariableViewHelperTrait;
use TRAW\VhsCol\Utility\ErrorUtility;
...
class SortViewHelper extends AbstractViewHelper
{
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument(
            'keepOldIndex',
            'string',
            'Keep the old index as this new variable',
            false
        );
        $this->registerArgument(
            'sortFlags',
    ...
    protected static function sortArray($array, $arguments)
    {
        ...
        foreach ($array as $index => $object) {
            if (is_array($object) && $arguments['keepOldIndex'] ?? false) {
                $oldIndex = $index;
